...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!copy Allchr.txt into data_dir/all_chr
...
#
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! copy data_dir/raw_beds/LAPA   data_dir/raw_beds/Cerberus_replicates  and cerb_repl/repl_to_experiment.txt
mkdir -p data_dir/Cerberus # Cerberus replicates will be combined into a file in this directory
