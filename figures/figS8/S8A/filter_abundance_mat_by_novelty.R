# TODO make this take 3 cmd line args
# 1. novelties
# 2. filt ab
# 3. output file
...
option_list <- list(
  make_option(
    c('--novelties', type='character', default=NULL, help=''),
    c('--filtab', type='character', default=NULL, help=''),
    c('--ofile', type='character', default=NULL, help=''),
  )
)
