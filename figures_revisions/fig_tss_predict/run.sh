...
# SFig 6f: training/plots/AUROC_diff_cell_line_boxplot.pdf
...
# LAPA replicates will be combined into a file in this directory
mkdir -p data_dir/raw_beds/LAPA 
Rscript combine_LAPA_replicates.R
echo "############################# LAPA replicates are combined"
