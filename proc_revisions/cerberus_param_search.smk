...
rule param_cerb_agg_human_tss_config:
    input:
        v40 = expand(config['ref']['param_search']['cerberus']['new_ends'],
                     species='human',
                     end_mode='tss')[0],
        v29 = expand(config['ref']['param_search']['cerberus']['ends'],
                     species='human',
                     end_mode='tss')[0],
        lapa = expand(config['lr']['param_search']['cerberus']['ends'],
                      species='human',
                      end_mode='tss')[0],
        gtex = expand(config['gtex']['param_search']['cerberus']['ends'],
                      end_mode='tss',
                      species='human')[0],
...
rule param_cerb_agg_ics_human_config:
    input:
        v40 = expand(config['ref']['param_search']['cerberus']['new_ics'],
                     species='human')[0],
        v29 = expand(config['ref']['param_search']['cerberus']['ics'],
                     species='human')[0],
        lapa = expand(config['lr']['param_search']['cerberus']['ics'],
                     species='human')[0],
        gtex = expand(config['gtex']['param_search']['cerberus']['ics'],
                      species='human')[0]
    params:
        sources = ['v40', 'v29', 'lapa', 'gtex'],
        refs = [True, True, False, False]
    resources:
        ...
        threads = 1
    output:
        cfg = expand(config['lr']['param_search']['cerberus']['agg_ics_cfg'],
                     species='human')[0]
    run:
